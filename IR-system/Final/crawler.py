...
class Crawler:
    ...
    def parse_urls(self, url, hasHTML = False):
        ...
        try:
            ...
            return [i.a.get('href') for i in soup.find_all(class_='row post-item')]
    ...
    def crawl(self, pages = 71, levels = 2):
        '''
        Automated crawling process that start from the seed url
            pages: number of page to crawl
